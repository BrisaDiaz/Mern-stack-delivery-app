    ...
    return (
      <ProductDetails>
        ...
        <ImageWrapper isLoaded={isLoaded}>
          <PrductImg
            src={thisProductInfo?.img}
            alt={thisProductInfo?.name}
        ...
        <Line />
        <dl>
          <Leyend>Categoría:</Leyend>{" "}
          <Deltail>{thisProductInfo?.category}</Deltail>
          <Leyend>Porción:</Leyend> <Deltail>{thisProductInfo?.size}</Deltail>
          <Leyend>Precio:</Leyend> <Deltail>${thisProductInfo?.price}</Deltail>
          <Leyend>Descripción:</Leyend>{" "}
          <Description>{thisProductInfo?.description}</Description>
        </dl>
      </ProductDetails>
    );
}
